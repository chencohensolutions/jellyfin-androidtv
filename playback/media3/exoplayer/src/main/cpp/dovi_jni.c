...
Java_org_jellyfin_playback_media3_exoplayer_DoviRpu_nativeStatus(JNIEnv *env, jobject thiz) {
    (void)env;
    (void)thiz;
    resolve_libdovi();
    return (jint)status;
...
Java_org_jellyfin_playback_media3_exoplayer_DoviRpu_nativeConvert(
    JNIEnv *env,
    jobject thiz,
    jbyteArray data,
    jint offset,
